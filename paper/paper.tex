...
\begin{itemize}
 ...
 \item We generated time-shifts $\beta_i$ for 100 subjects (disease $d_0$) and 50 subjects (disease $d_1$), $\beta_i \sim U(-13,10)$ years before/after disease onset. 
 ...
 \item For each subject and each biomarker, we generated data for four consecutive visits, each visit one year apart. The noise standard deviation $\epsilon_k$ = 0.05.
\end{itemize}

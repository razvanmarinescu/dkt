...
\heading{Inference}: Perform loopy belief propagation
...
\begin{itemize}
 \item Dementia Research Center cohort: 76 PCA, 67 tAD, 87 age-matched controls.
 \item TADPOLE Challenge dataset split into three cohorts with different progressions: hippocampal, cortical and subcortical.
 \item Synthetic dataset mimicking the DRC cohort.
\end{itemize}
...
%  \item Inferred, likely for the first time, continuous multimodal trajectories for Posterior Cortical Atrophy
%  \item 
\end{itemize}
